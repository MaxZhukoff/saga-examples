package ru.quipy.saga.defaultsimple.trips.logic

import ru.quipy.core.annotations.StateTransitionFunc
import ru.quipy.domain.AggregateState
import ru.quipy.saga.defaultsimple.trips.api.*
import java.util.*
...
class Trip : AggregateState<UUID, TripAggregate> {
    ...
    fun tripStartReservation(cost: Int, id: UUID = UUID.randomUUID()): TripReservationStartedEvent {
